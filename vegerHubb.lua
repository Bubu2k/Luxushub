...
ImageButton1.Image = "rbxassetid://109035098027651"
...
Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Auto Complete Trial V4", Default = _G.AutoCompleteRace })
    Toggle:OnChanged(function(Value)
                                ...
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    pcall(function()
                                        repeat 
                                            ...
                                            v.HumanoidRootPart.CanCollide = false
                                            sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                        until not _G.AutoCompleteRace or not v.Parent or v.Humanoid.Health <= 0
                                    end
                                    )
                                end
                            end
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Skill Z", Default = false })

    Toggle:OnChanged(function(raceZ)
        _G.ConCacZ = raceZ
    end)

local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Skill X", Default = false })

    Toggle:OnChanged(function(raceX)
        _G.ConCacX = raceX
    end)

local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Skill C", Default = false })

    Toggle:OnChanged(function(raceC)
        ConCacC = raceC
    end)
